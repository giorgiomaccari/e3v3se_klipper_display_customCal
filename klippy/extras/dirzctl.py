...
class DirZCtl:
    def __init__(self, config):
        ...
        self.mcu.register_serial_response(
            self._handle_result_dirzctl, "result_dirzctl", self.oid)
        ...
        self.step_base = config.getfloat(
            'step_base', default=2, minval=1, maxval=6)
    ...
    def cmd_DIRZCTL(self, gcmd):
        index = gcmd.get_int('INDEX', len(self.steppers),
                             minval=0, maxval=len(self.steppers))
